...
export type ProjectStatus = 'Planning' | 'In Progress' | 'Launched' | 'Archived';
...
export const mockProjects: Project[] = [
  {
    ...
    features: [
      ...
      },
      {
        ...
        description: 'Improve responsive behavior and touch interactions on mobile devices',
        priority: 'Medium',
        status: 'In Progress',
        ...
        tasks: [
          ...
          },
          {
            ...
            description: 'Replace CSS grid with flexbox for better mobile control',
            status: 'Done',
            dueDate: '2026-02-15',
            effortEstimate: '2 hours',
          },

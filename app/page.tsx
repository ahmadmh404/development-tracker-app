...
import { ArrowRight, FolderKanban, CheckCircle2, Clock } from 'lucide-react';
...
export default function DashboardPage() {
  // Calculate stats
  const totalFeatures = mockProjects.reduce((sum, p) => sum + p.features.length, 0);
  const allTasks = mockProjects.flatMap((p) => p.features.flatMap((f) => f.tasks));
